...
CREATE TABLE documents (
    ...
    landowner_id INT NULL,
    folder_id INT NULL,
    doc_type ENUM('property_register','building_register','consent_form','briefing_material','contract','photo','other','consent_form_template','contract_template','cadastral_map','consultant_document','roi_report','willingness_form','landowner_roster') NOT NULL DEFAULT 'other',
...
-- 19. activity_logs (audit trail of every mutating request - backs 個人工作看板 今日操作紀錄)
...
-- 20. calendar_events (work-board calendar notes; project_id NULL = private to creator)
CREATE TABLE calendar_events (
    ...
    CONSTRAINT fk_calendar_events_project FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
